              ...
              <form onSubmit={handleTrackSubmit} className="max-w-md mx-auto mb-6">
                <div className="flex gap-3">
                  <input
                    ...
                    placeholder="R-XXXXX"
                    className="flex-1 px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-center font-mono font-medium text-gray-900"
                  />
                  <button
                    type="submit"
