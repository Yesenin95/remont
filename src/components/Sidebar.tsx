...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full w-72 bg-linear-to-b from-blue-600 to-indigo-700 text-white transform transition-transform duration-300 ease-in-out z-50 ${
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-t border-white/20">
            <div className="space-y-3">
              <Link href="tel:+79991234567" className="flex items-center gap-2 text-sm hover:text-white/80">
